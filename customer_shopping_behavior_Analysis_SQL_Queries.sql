...
select item_purchased,round(avg(review_rating),2) as Average_product_rating from customer_behavior.customer  group by item_purchased order by avg(review_rating) desc limit 5;
